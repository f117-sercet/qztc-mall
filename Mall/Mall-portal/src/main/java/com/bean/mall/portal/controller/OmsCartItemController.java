...
public class OmsCartItemController {
    ...
    @ResponseBody
    public CommonResult<List<CartPromotiomItem>> listPromotion(@RequestParam(required = false) List<Long> cartIds) {
        List<CartPromotiomItem> cartPromotionItemList = cartItemService.listPromotion(memberService.getCurrentMember().getId(), cartIds);
